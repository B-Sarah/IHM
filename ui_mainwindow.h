...
""));
        ...
        layoutWidget_2->setGeometry(QRect(393, 5, 64, 26));
        ...
        horizontalLayoutWidget = new QWidget(frame_14);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(9, 9, 731, 361));
        folderLayout = new QHBoxLayout(horizontalLayoutWidget);
        folderLayout->setSpacing(6);
        folderLayout->setContentsMargins(11, 11, 11, 11);
        folderLayout->setObjectName(QStringLiteral("folderLayout"));
        folderLayout->setSizeConstraint(QLayout::SetFixedSize);
