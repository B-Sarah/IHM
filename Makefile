...
# Template: app
# Command: /home/salex/Qt5.8.0/5.8/gcc_64/bin/qmake -o Makefile FileTagger.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
QMAKE         = /home/salex/Qt5.8.0/5.8/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
DISTDIR = /home/salex/Projet_IHM/.tmp/FileTagger1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/salex/Qt5.8.0/5.8/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/salex/Qt5.8.0/5.8/gcc_64/lib -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
>>>>>>> 2f05879fdc7304b5741d42c8e7ecfc286c162c5c
...
=======
		...
		../Qt5.8.0/5.8/gcc_64/include/QtWidgets/QListView \
		...
		../Qt5.8.0/5.8/gcc_64/include/QtWidgets/QScrollArea \
